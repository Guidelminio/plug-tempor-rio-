...
O processo de build também limpa caches locais do Expo e do NativeWind antes da exportação. Essa medida evita que o Metro tente empacotar o arquivo temporário `react-native-css-interop/.cache/web.css`, que pode não existir no ambiente isolado de publicação.
